...
A portfolio-quality app for tracking pain points and change requests, with AI-assisted structuring and prioritization — demoable in 30 seconds by any recruiter.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "240270097+limdavid2200-svg@users.noreply.github.com"
  git config user.name "limdavid2200-svg"
  ```
